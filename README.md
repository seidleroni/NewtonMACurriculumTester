...
**Phases 0–2 are done** (see [`STATUS.md`](STATUS.md) for the full done / not-done breakdown):
the skill engine, mastery + spaced-repetition scheduler, the full daily loop, kid and parent
dashboards, and **73 math skills across Grades 2–4** — including image-based skills (clocks,
number lines, arrays, grids, bar graphs, fraction bars) that render deterministically and embed
inline. Jacob starts on Grade 2, Samuel on Grade 4; Grade 3 is included as a cross-grade safety net.
